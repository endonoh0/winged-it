    ...
    <section id="about">
      <div className="home_div_bottom">
        ...
        <div className="home_text">
          <p className="home_desription_text">Whether you're looking for a healthy recipes or ideas on how to use leftovers from your fridge, we've numerous recipes to choose from. You can browse on-season vegetables/fruits and see the closest local farmer market to you. </p>
        </div>
